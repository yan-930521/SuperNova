...
## 4. Coding & Commenting Style
To enable smooth collaboration between global developers and the local team, we adopt a bilingual mixed standard:
...
- **Commenting Conventions:** All code comments **MUST** be written in Traditional Chinese (zh-TW). Comments should detail the logical intent, edge cases, and potential risks, and should be self-contained.
