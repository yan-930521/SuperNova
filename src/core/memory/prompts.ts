...
export const GRAPH_EXTRACTOR_SCHEMA = z.object({
    entities: z
        .array(
            z.object({
                id: z.string().describe("Atomic entity ID (e.g., 'User', 'Yan', 'SuperNova', 'Bun')"),
...
export type GraphExtractionResult = z.infer<typeof GRAPH_EXTRACTOR_SCHEMA>;
